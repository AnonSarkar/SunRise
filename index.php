...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8801777888555</li>	
					<li class="s-bar">
						<div class="search">
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/teamsx.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/teamsx.jpg" alt=" " class="img-responsive" />
					</li>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Manager Name</h4>
							<span>Manager</span>
							<p>"The first rule of management is delegation. Don't try and do everything yourself because you can't" </p>
					...
					<ul class="slides">
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/jj.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
...
<!-- /contact -->
			<div class="copy">
		        <p>" It Takes Months To Find A Customer, But Minutes To Loose One " <a href="index.php">SUNRISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
